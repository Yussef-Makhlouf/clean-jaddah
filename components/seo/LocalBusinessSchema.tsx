...
const defaultBusiness = {
  name: "أفضل شركة تنظيف في جدة",
description: "أفضل شركة تنظيف في جدة تقدم خدمات تنظيف منازل، مكاتب، سجاد، نوافذ، وتعقيم في جدة بأعلى معايير الجودة وبأسعار منافسة.",
