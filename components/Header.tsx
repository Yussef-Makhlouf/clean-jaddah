      ...
      <div className="hidden lg:block bg-[#1976D2] text-white py-1">
        <div className="container mx-auto px-6 flex justify-between items-center text-sm">
          <div className="flex items-center gap-4">
            <a href="tel:+966563009155" className="flex items-center gap-1 hover:text-yellow-300 transition-colors" aria-label="اتصل بنا">
              <Phone className="w-4 h-4" />
              <span>+966563009155</span>
            </a>
          ...
          <div className="md:hidden bg-white border-t mt-4 py-4 animate-fadeIn">
            <div className="flex flex-col space-y-3">
              ...
              <div className="border-t border-gray-200 pt-3 mt-3 px-6 flex justify-center space-x-4 rtl:space-x-reverse">
                <a href="tel:0563009155" className="text-gray-600 hover:text-[#1976D2] transition-colors" aria-label="اتصل بنا">
