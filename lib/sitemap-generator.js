...
function generateSitemap() {
  ...
  const sitemapEntries = [
    ...
    {
      url: `${baseUrl}/about/`,
      priority: SEO_CONFIG.PAGE_PRIORITIES.ABOUT,
      changefreq: SEO_CONFIG.CHANGE_FREQUENCIES.ABOUT,
    },
    
    // صفحة اتصل بنا
    {
      url: `${baseUrl}/contact/`,
      priority: SEO_CONFIG.PAGE_PRIORITIES.CONTACT,
      changefreq: SEO_CONFIG.CHANGE_FREQUENCIES.CONTACT,
    },
